...
class _AdminPageState extends State<AdminPage> {
  ...
  // Separate controller for blocking users to avoid accidental reuse
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: Column(
              children: [
                // Make the top forms scrollable to avoid keyboard overflow on small screens
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: accentRed.withOpacity(0.25)),
                        ),
                        child: Column(
                              ...
                              children: [
                                Expanded(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelStyle:
                                          const TextStyle(color: subtleText),
                                      filled: true,
                                      fillColor: fieldBg,
                                      enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(14),
                                ...
                                FilledButton(
                                  ...
                                  onPressed: _blockingInProgress
                                      ? null
                                      : () async {
                                          final email = blockCtrl.text.trim();
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (val != null) {
                                      ...
                                      try {
                                        await qp.updateQueueSettings(q.id,
                                            {'noShowTimeoutSeconds': secs});
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(const SnackBar(
                                                content:
                                                    Text('Timeout updated.')));
                                      } catch (e) {
                                        ScaffoldMessenger.of(context)
